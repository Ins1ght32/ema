            ...
            steps {
                script {
                    ...
                    withSonarQubeEnv('SonarQube EMA') {
						...
						sh "${scannerHome}/bin/sonar-scanner -Dsonar.projectKey=D3 -Dsonar.sources=. -Dsonar.host.url=http://192.168.1.188:9000 -Dsonar.token=sqp_3f5384f18a8b5e7b8aaf8bd9acefbc32b2c063ac"
                    }
                }
            }       
        }
