...
export default function DeleteBulkHostnamesForm({ open, onClose, onSubmit, selectedRows }) {
    ...
    return (
        <Dialog open={open} onClose={onClose}>
            <DialogTitle>Enter Hostnames to Delete</DialogTitle>
            <DialogContent>
                Hostnames
                <TextField
                margin="dense"
...
DeleteBulkHostnamesForm.propTypes = {
