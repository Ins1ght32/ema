...
export default function ProductsView() {
  ...
  */
  ...
  const handleAddSubmit = async (formData) => {
    setLoading(true);
    const response = await fetch(`${import.meta.env.VITE_WEBSITE_BACKEND_URL}/add-product`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const handleCrawlNow = async () => {
    setLoading(true);
    const response = await fetch(`${import.meta.env.VITE_WEBSITE_BACKEND_URL}/crawlNow`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const handleEditSubmit = async (formData) => {
    ...
    const response = await fetch(`${import.meta.env.VITE_WEBSITE_BACKEND_URL}/edit-product`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const handleDeleteButton = async (rowData, arrayData) => {
    ...
    const response = await fetch(`${import.meta.env.VITE_WEBSITE_BACKEND_URL}/delete-product`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const fetchData = async () => {
    setLoading(true);
    const response = await fetch(`${import.meta.env.VITE_WEBSITE_BACKEND_URL}/all-products`);
  ...
  const getCrawlTime = async () => {
    const response = await fetch(`${import.meta.env.VITE_WEBSITE_BACKEND_URL}/crawl-time`);
    const json = await response.json();
